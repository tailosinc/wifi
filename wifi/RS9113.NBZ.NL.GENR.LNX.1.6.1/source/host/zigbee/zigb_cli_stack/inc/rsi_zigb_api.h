...
#define ZIGBEEGETRSSI				             0xF6
#define ZIGBEE_DEBUG				             0xF7
#define ZIGBEE_HEART_BEAT                         0xF8
...
#define SET_ZIGBEE_DEBUG_MODE     0
#define GET_MEMORY_TABLE          1
#define GET_TRANSACTION_TABLE	  2
#define GET_MAC_QUEUE_TABLE		  3
#define GET_APP_QUEUE_TABLE	   	  4
#define GET_MSC_QUEUE_TABLE	   	  5
#define GET_SAS_INFO   	  	      6
#define ZIGBEE_DEBUG_TRACE		7
#define GET_MSDU_TABLE	  		  8
 ...
 *******************************************************************************/
typedef struct APP_Startup_Attribute_Set_Tag
{
...
extern const uint8_t rsi_zigb_frameHeartBeat[RSI_ZIGB_BYTES_2];
extern const    uint8_t   rsi_zigb_frameInitStack[RSI_ZIGB_BYTES_2];
extern const    uint8_t   rsi_zigb_frameGetRssi[RSI_ZIGB_BYTES_2];
extern const    uint8_t   rsi_zigb_frameDebug[RSI_ZIGB_BYTES_2];
...
int16_t rsi_zigb_get_debug_info(uint8_t query_type, uint8_t data);
...
int16_t rsi_zigb_update_sas(APP_Startup_Attribute_Set_t *);
