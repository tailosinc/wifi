...
/******************************* events ******************************/
#define SCAN_COMPLETE_EVENT	0x01
#define STACK_STATUS_EVENT	0x02
#define SEND_CONFIRMATION_EVENT 0x03
...
extern ZigBeeNWKStatusInfo nwkStatusInfo;
...
#else
RSI_ZB_STATUS rsi_zigb_handle_data(uint8_t cmd,uint8_t intf);
#endif
